    ...
    if (audioRef.current) {
      audioRef.current
        ...
        .catch((error) => {
          ...
          // Optionally, you can prompt the user to click play manually here.
          setIsPlaying(false);
        });
    }
  }, [src]);
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        layout
      >
        <audio ref={audioRef} onTimeUpdate={handleTimeUpdate} src={src} className="hidden" autoPlay />
        ...
        >
          ...
          <motion.div className="flex flex-col w-full gap-y-2">
            ...
            <div className="my-2">
              ...
              {subtitle && <motion.h3 className="text-secondary text-xs text-center">{subtitle}</motion.h3>}
            </div>
            ...
            <motion.div className="flex flex-col gap-y-1">
              ...
              <div className="flex items-center justify-between">
                <span className="text-white text-sm">{currentTime ? formatTime(currentTime) : "0:00"}</span>
                <span className="text-white text-sm">{duration ? formatTime(duration) : "-"}</span>
              </div>
            </motion.div>
